...
- (b2Body *)createBody:(CGPoint)location {
    ...
    b2Vec2 vertices[4];
    int num = 4;
    vertices[0].Set(120.5f / PTM_RATIO, 87.5f / PTM_RATIO);
    vertices[1].Set(87.5f / PTM_RATIO, 120.5f / PTM_RATIO);
    vertices[2].Set(-120.5f / PTM_RATIO, -87.5f / PTM_RATIO);
    vertices[3].Set(-87.5f / PTM_RATIO, -120.5f / PTM_RATIO);
